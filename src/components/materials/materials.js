      ...
      <div>
        {isMobile ? (
          <div className="materials-background">
            <p className="jsm-Container-instructions">
              Use the Job Search Materials page to keep track of the essential
              documents needed when applying for jobs. Log into Job Tracker
              while applying and you can quickly copy and paste the information
